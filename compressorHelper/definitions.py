...
LookAheadSpec = [
    ...
    ('delayedInput', float32[:,:]),   # 2D float32 array for delayed input
]
...
class LookAheadSettings:
    ...
    Attributes:
        ...
        delayedInput (float32[:,:]): The delayed input data (e.g., a 2D NumPy array).
    """
    def __init__(self,
                 delay,
                 delayInSamples,
        ...
        self.delayedInput = np.asarray(delayedInput, dtype=np.float32)
...
def setSettings(
    ...
    global compressionSettings, gainReductionSettings, lookAheadSettings
